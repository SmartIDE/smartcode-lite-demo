...
import { getDatabaseContext1, runQuery } from './utils';
import {
    encode,
    encodeChat,
    decode,
...
const SMARTCODE_PARTICIPANT_ID = 'leansoftx.smartcode-lite.db-helper';
const TOKEN_LIMIT_GPT35_TURBO = 8196;//4096;
